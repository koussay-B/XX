<template>
  <div class="max-w-md mx-auto space-y-6 relative">
    ...
    <button
      ...
      class="w-full h-10 rounded-lg border border-gray-200 bg-white text-gray-700 font-semibold text-xs transition-all shadow-sm hover:shadow-md hover:border-gray-300 active:scale-95 flex items-center justify-center gap-2"
    >
    ...
    <form @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <router-link
        ...
        class="w-full h-12 rounded-xl bg-gray-900 text-white font-bold text-sm transition-all shadow-lg hover:shadow-emerald-100 active:scale-95 flex items-center justify-center gap-2"
      >
